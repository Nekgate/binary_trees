...
/**
 * smallest - This gets the smallest node
 * @node: tree to query
 *
...
/**
 * remove_node - This removes a value from a binary search tree
 * @root: tree to query
...
/**
 * adjust_balance_1 - This adjusts the balance of an AVL tree by
